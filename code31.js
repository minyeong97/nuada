...
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(9475340);
}
...
{for(var i = 0, len = gdjs.startSceneCode.GDNewTextObjects1.length ;i < len;++i) {
    gdjs.startSceneCode.GDNewTextObjects1[i].getBehavior("Tween").addObjectPositionYTween2("creditScroll", -(1800), "linear", 50, false);
}
